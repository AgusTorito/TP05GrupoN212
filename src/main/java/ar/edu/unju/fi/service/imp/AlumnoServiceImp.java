...
public class AlumnoServiceImp implements AlumnoService {
	...
	public void modificarAlumno(AlumnoDTO alumnoDTO) {
		...
		Alumno alumnoModificado = alumnoMapDTO.convertirAlumnoDTOAAlumno(alumnoDTO);
		...
		{	
			...
			if(alumnos.getDni().equals(alumnoModificado.getDni())) {
				losAlumnos.set(i, alumnoModificado);
				break;
			}
		}
	}
